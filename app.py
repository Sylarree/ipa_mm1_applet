...
left_pad, col1, col2, col3, col4, col5, col6, right_pad = st.columns([0.5, 1, 1, 1, 0.7, 1, 1, 0.5])
...
with col3:
    N = st.number_input("N", value=100000, min_value=1000)
...
if run or "ran_once" not in st.session_state:
    ...
    if lam >= mu:
        ...
        _, m1, m2, m3 = st.columns([0.4, 1, 1, 0.7])
